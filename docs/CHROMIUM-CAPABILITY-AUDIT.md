...
| Chrome extensions | Trusted review/staging/install/uninstall/restart replay uses Chromium's extension support.        | [SDK and MCP inventory/removal](EXTENSIONS.md#public-inventory-and-removal); installation review and change events remain private/unavailable. |
