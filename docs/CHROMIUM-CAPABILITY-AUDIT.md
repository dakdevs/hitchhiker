...
| DevTools UI       | Host, SDK and MCP controls; portable and isolated real Chromium lifecycle tests pass.             | [Production Keychain startup and default integration remain open](DEVTOOLS.md); docking is unavailable. |
